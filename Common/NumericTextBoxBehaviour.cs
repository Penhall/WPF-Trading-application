...
namespace CommonFrontEnd.Common
{
    public class NumericTextBoxBehaviour : Behavior<TextBox>
    {
        ...
        public static DependencyProperty IsEnabledProperty =
            DependencyProperty.RegisterAttached("IsEnabled", typeof(bool), typeof(NumericTextBoxBehaviour),
        ...
        public static readonly DependencyProperty AllowDecimalProperty = DependencyProperty.Register(
            "AllowDecimal",
            typeof(bool),
            typeof(NumericTextBoxBehaviour),
            new PropertyMetadata(false));
        //public static readonly DependencyProperty AllowRangeProperty = DependencyProperty.Register(
        //   "AllowRange",
        //   typeof(bool),
        //   typeof(NumericTextBoxBehaviour),
        //   new PropertyMetadata(false));
        ...
        //    get
        //    {
        //        return (bool)base.GetValue(AllowRangeProperty);
        //    }

        //    set
        //    {
        //        base.SetValue(AllowRangeProperty, value);
        //    }
        //}
        ...
        private static void OnIsEnabledChanged(DependencyObject dpo, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (tb != null)
            {
                ...
                var existingBehavior = behColl.FirstOrDefault(b => b.GetType() == typeof(NumericTextBoxBehaviour)) as NumericTextBoxBehaviour;
                ...
                {
                    behColl.Add(new NumericTextBoxBehaviour());
                }
            }
        }
        #endregion
        ...
        public static readonly DependencyProperty AllowMouseDragProperty = DependencyProperty.Register("AllowMouseDrag", typeof(bool),
                typeof(NumericTextBoxBehaviour), new FrameworkPropertyMetadata(false));
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(long), typeof(NumericTextBoxBehaviour), new PropertyMetadata(Int64.MinValue));
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(long), typeof(NumericTextBoxBehaviour), new PropertyMetadata(Int64.MaxValue));
        ...
        {
            private readonly NumericTextBoxBehaviour _behaviorOwner;
            Point _lastPos;
            bool _isCaptured;
            bool _changedValue;
            ...
            public CursorAdorner(TextBox textBox, NumericTextBoxBehaviour behaviorOwner)
                : base(textBox)
            {
        ...
        private void AssociatedObject_PreviewTextInput(object sender, TextCompositionEventArgs e)
        {
            if (!string.IsNullOrEmpty(e.Text))
            {
                ...
                //if(AllowRange)
                //{
                //    if ((Convert.ToChar(e.Text)) > 1000000000)
                //    {
