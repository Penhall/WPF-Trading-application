...
namespace CommonFrontEnd.Common
{
    public class BowConstants
    {
        ...
        public static string SERVLET_NAME_PRE_EDIT_ORDER = "PreEditOrder";
        public static string OE_ID = "OEID";
        public static string OE_TRANSCODE = "OETransactionCode";
        public static int NUMBER_OF_ORDER_PARAMETERS = 82;
        public static string SERVLET_NAME_ADD_ORDER = "AddOrder";
        public static string SERVLET_NAME_EDIT_ORDER = "EditOrder";
        public static string SERVLET_NAME_DELETE_ORDER = "DeleteOrder";
        public static string SERVLET_NAME_DELETE_UNSENTORDER = "CancelUnsentOrders";
        public static int ORDER_MODIFICATION_TRANSCODE = 2040;
        public static int ORDER_CANCELLATION_TRANSCODE = 2070;
        public static string SERVLET_NAME_ADMINDELETE_ORDER = "AdminDeleteOrder";
        public static string SERVLET_NAME_ADMINSQUAREOFF_ORDER = "AdminSquareOff";
        public static string SERVLET_NAME_ARBITRAGE_ORDER_ENTRY = "ArbitrageOrderEntry";
        public static string OEDestination = "OEDestination";
        public static string OEDestination_value = "1";

        public static string PARAMEXCHANGE = "exchange";
        public static string PARAMSEGMENT = "segment";
        public static string PARAMTARGETEXCHANGE = "targetexchange";
        public static string PARAMTARGETSEGMENT = "targetsegment";
        public static string PARAMMARKET = "market";
        public static string PARAMOPTIONTYPE = "optiontype";
        public static string PARAMINSTRUMENTTYPE = "instrumenttype";
        public static string PARAMSYMBOL = "symbol";
        public static string PARAMSERIES = "series";
        public static string PARAMCOMPANYNAME = "companyname";
        public static string PARAMEXPIRYDATE = "expirydate";
        public static string PARAMBUYSELLINDICATOR = "buysellindicator";
        public static string PARAMUSER = "user";
        public static string PARAMTOKEN = "token";
        public static string PARAMSECURITYTOKENS = "securitytokens";
        public static string PARAMCONTRACTTOKENS = "contracttokens";
        public static string PARAMCONTRACTID = "contractId";
        public static string PARAMSTRIKEPRICE = "strikeprice";
        public static string PARAMUSERS = "users";
        public static string PARAMACCOUNT = "account";
        public static string PARAMUSERID = "userId";
        public static string PARAMSTARTDATE = "startDate";
        public static string PARAMENDDATE = "endDate";
        public static string PARAMSCRIPTCODE = "BSCScripCode";
        public static string PARAMSCRIPTID = "BSCSciptId";
        public static string PARAMSCRIPTNAME = "BSCScriptName";
        public static string PARAMGROUP = "group";
        public static string PARAMAGGREGATE = "aggregate";
        public static string PARAMTRADEUSERID = "tradeuserid";
        public static string PARAMINTRADAY = "intraday";
        public static string PARAMDEPOSITAMOUNT = "depositamount";
        public static string PARAMPROFILENAME = "profile";
        public static string PARAMORDERNUMBER = "ordernumber";
        public static string PARAMTRADETIME = "TradeTime";
        public static string PARAMACTIVITYLOGTIME = "ActivityLogTime";
        public static string PARAMACTIVITYLOGTOTIME = "ActivityLogToTime";
        public const int NUMBER_OF_SEARCH_PARAMETERS = 23;

#elif TWS
        public class TWSConstantsMessages
        {
            //Order Constant
            public readonly string ErrorCd001 = "Order Book Restatement";
            public readonly string ErrorCd101 = "Order Added";
            public readonly string ErrorCd102 = "Order Replaced";
            public readonly string ErrorCd105 = "IOC Order Cancelled";
            public readonly string ErrorCd108 = "Book Order Executed";
            public readonly string ErrorCd135 = "Market Order Triggered";
            public readonly string ErrorCd164 = "OCO Order Triggered";
            public readonly string ErrorCd172 = "Stop Order Triggered";
            public readonly string ErrorCd212 = "BOC Order Cancelled";
            public readonly string ErrorCd199 = "Pending Cancellation Executed";
            public readonly string ErrorCd215 = "RRM Order Added";
            public readonly string ErrorCd216 = "RRM Order Accepted";
            public readonly string ErrorCd217 = "RRM Order Updation Rejected";
            public readonly string ErrorCd218 = "RRM Order Updated Successfully";
            public readonly string ErrorCd219 = "RRM Order Deleted";
            public readonly string ErrorCd220 = "RRM Market Order Triggered";
            public readonly string ErrorCd221 = "Provisional Order Added";
            public readonly string ErrorCd222 = "Provisional Order Accepted";
            public readonly string ErrorCd223 = "Provisional Order Updation Rejected";
            public readonly string ErrorCd224 = "Provisional Order Updated Successfully";
            public readonly string ErrorCd225 = "Provisional Order Deleted";
            public readonly string ErrorCd226 = "Provisional Market Order Triggered";

            public readonly string ErrorCd231 = "CALLAUC Order Deleted";
            public readonly string ErrorCd232 = "Order Cancelled: Session Expiry";

            public readonly string ErrorCd233 = "Order Cancelled: Day Expiry";
            public readonly string ErrorCd234 = "Order Cancelled: Halt";
            public readonly string ErrorCd235 = "Block Deal Order Timed Out";

            public readonly string ErrorCd236 = "Out Of Price Band Order";
            public readonly string ErrorCd237 = "Order Worse Than Close Price";

            public readonly string ErrorCd238 = "Auction Market Order Triggered";
            public readonly string ErrorCd243 = "Order Cancelled : SPOS Price undetermined";

            public readonly string ErrorCd246 = "Self Trade Order Deleted";
            public readonly string ErrorCd247 = "Reverse Trade Order Deleted";
